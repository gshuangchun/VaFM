...
def solve(instance: TensorDict, max_runtime: float, **kwargs) -> tuple[Tensor, Tensor]:
    ...
    Notes
    -----
    This function depends on PyVRP's data_ori converter to convert the AnyVRP
...
class ORToolsData:
    """
    Convenient dataclass for instance data_ori when using OR-Tools as solver.
...
def instance2data(instance: TensorDict) -> ORToolsData:
    ...
    """
    # TODO: Do not use PyVRP's data_ori converter.
    ...
    # Set data_ori to None if instance does not contain explicit values.
