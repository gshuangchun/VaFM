...
class MVMoEDecoder(AttentionModelDecoder):
    ...
    #         self, embeddings: TensorDict, num_starts: int = 0
    # ) -> PrecomputedCache:
    ...
    #     coor_embeddings = embeddings["h"]
    #     (
    #         glimpse_key_fixed,
    #         glimpse_val_fixed,
    #         logit_key_fixed,
    #     ) = self.project_node_embeddings(coor_embeddings).chunk(3, dim=-1)
    #
    #     # Optionally disable the graph context from the initial embedding as done in POMO
    #     if self.use_graph_context:
    #         graph_context = self.project_fixed_context(coor_embeddings.mean(1))
    #     else:
    #         graph_context = 0
    #
    #     # Organize in a dataclass for easy access
    #     return PrecomputedCache(
    #         node_embeddings=coor_embeddings,
